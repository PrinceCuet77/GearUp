...
const createPaymentInDB = async (
  ...
  const sslPayload = {
    ...
    success_url: `${config.api_url}/api/payments/confirm?orderId=${rentalOrder.id}&tranId=${transactionId}&status=success`,
    fail_url: `${config.api_url}/api/payments/confirm?orderId=${rentalOrder.id}&tranId=${transactionId}&status=fail`,
    cancel_url: `${config.api_url}/api/payments/confirm?orderId=${rentalOrder.id}&tranId=${transactionId}&status=cancel`,
